...
void Direct3DBase::UpdateForWindowSizeChange()
{
    if (m_window->Bounds.Width  != m_windowBounds.Width ||
        ...
        m_orientation != DisplayProperties::CurrentOrientation)	//if the current window bounds does not match the ones set in the game and the orientation is not correct
    {
...
Windows::Graphics::Display::DisplayOrientations Direct3DBase::returnOrientation()
{
...
void Direct3DBase::ComputeOrientationMatrices()
{
    ...
    switch(m_orientation)
    {
        case DisplayOrientations::Landscape:
            {
                m_orientationTransform2D = XMMatrixMultiply(XMMatrixRotationZ(XM_PIDIV2), XMMatrixTranslation(m_renderTargetSize.Width, 0, 0));
                m_orientedScreenSize = Size(m_renderTargetSize.Height, m_renderTargetSize.Width);
                break;
            }
        case DisplayOrientations::LandscapeFlipped:
            {
                m_orientationTransform2D = XMMatrixMultiply(XMMatrixRotationZ( 3 * XM_PIDIV2), XMMatrixTranslation(0, m_renderTargetSize.Height, 0));
                m_orientedScreenSize = Size(m_renderTargetSize.Height, m_renderTargetSize.Width);
                break;
            }
        default:
